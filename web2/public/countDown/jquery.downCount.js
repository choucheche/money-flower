...
(function ($) {
    ...
    $.fn.downCount = function (options, callback) {
        ...
        function countdown () {
            ...
            container.find('.days_ref').text(ref_days+'天');
            container.find('.hours_ref').text(ref_hours+'时');
            container.find('.minutes_ref').text(ref_minutes+'分');
            container.find('.seconds_ref').text(ref_seconds+'秒');
        };
